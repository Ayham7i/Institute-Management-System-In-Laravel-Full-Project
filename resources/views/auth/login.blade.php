                ...
                <div class="hero is-fullheight">
                    <div class="hero-heading">
                        ...
                        <div class="no-account-link has-text-centered">
                            <a href="{{route('register')}}"><i class="sl sl-icon-question"></i> I do not have an account yet </a>
                        </div>
                    </div>
                                        ...
                                        <div id="signin-form" class="login-form animated preFadeInLeft fadeInLeft">
											...
											<div class="field pb-10">
												<div class="control has-icons-left">
													<input class="input is-large" id="username" name="email" type="email" placeholder="Your Email" required>
