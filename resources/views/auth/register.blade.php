                                        ...
                                        <div id="signup-form" class="login-form animated preFadeInLeft fadeInLeft">
                                            <div class="field pb-10">
                                                <div class="control has-icons-left">
                                                    <input class="input is-large" type="text" id="name" name="name"  placeholder="Your Username *" required>
													<span class="icon is-left">
														<i class="im im-icon-Email"></i>
													</span>
                                                </div>
                                                @error('name')
                                                <div class="invalid-feedback" style="color: rgb(245, 72, 72)">{{ $message }}</div>
                                                @enderror
                                            </div>

                                            <div class="field pb-10">
                                                <div class="control has-icons-left">
                                                    <input class="input is-large" name="email" type="email" id="email" onblur="checkMailStatus()" placeholder="Your Email *" required>
													<span class="icon is-left">
														<i class="im im-icon-Email"></i>
													</span>
                                                </div>
                                            ...
                                            <div class="field pb-10">
                                                <div class="control has-icons-left">
                                                    <input class="input is-large" type="password" name="password" id="password" placeholder="Choose Password *" minlength="8" required>
													<span class="icon is-left">
                                            ...
                                            <div class="field pb-10">
                                                <div class="control has-icons-left">
                                                    <input class="input is-large" type="password" id="rpassword" name="password_confirmation" onblur="match();" placeholder="Confirm Password *" required>
													<span class="icon is-left">
														<i class="im im-icon-Lock"></i>
													</span>
                                                </div>
                                            ...
                                            <p class="control login mt-20">
                                                <button  id="signup" class="button button-cta bg-m-blue7 m-white btn-align-lg is-bold is-fullwidth rounded raised no-lh" style="border:none;" name="submit" type="submit">Sign up</button>
                                            </p>
